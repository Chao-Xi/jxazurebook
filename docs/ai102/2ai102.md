...
In **Azure QnA Maker (classic)**, the following built-in roles are used to control access:

| Role                       | Description                                                                       |
| -------------------------- | --------------------------------------------------------------------------------- |
| **QnA Maker Reader**       | Can **view** knowledge bases but **cannot edit** or **publish** them.             |
| **QnA Maker Editor**       | Can **create**, **edit**, **publish**, and **delete** knowledge bases.            |
| **Cognitive Service User** | Used for general Cognitive Services access, not specific to QnA Maker management. |
| **Contributor / Owner**    | Manage Azure resources, not suitable for app-level access control to QnA Maker.   |

---

✅ Reasoning:

* **AllUsers:** Should be able to **access** (read) the QnA content during normal use — but **not modify** it → **QnA Maker Read**
* **LeadershipTeam:** Should be able to **create and edit** QnA pairs (e.g., manage and update product FAQs) → **QnA Maker Editor**
