...
ou have an app named App1 that uses an Azure Blob Storage container named app1data.

App1 uploads a cumulative transaction log file named File1.txt to a block blob in app1data once every hour. File1.txt only stores transaction
data from the current day.

You need to ensure that you can restore the last uploaded version of File1.txt from any day for up to 30 days after the  le was overwritten.
...
![Alt Image Text](../images/az305_12_721.png "Body image")
...
![Alt Image Text](../images/az305_12_722.png "Body image")
...
* After a failover, configure geo-redundant storage (GRS) replication for the storage account.  ✅
	* Failover only supports GRS, GZRS, and RA-GZRS
