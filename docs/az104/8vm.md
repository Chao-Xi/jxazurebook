...
* **<mark>Used for storing persistent data like files or databases</mark>**
...
<mark>An example here is our **scaling definition can be that, if we have CPU utilization that is greater than 80%, well then, add one VM**. </mark>
