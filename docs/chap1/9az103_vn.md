...
### **1-1 Azure Virtual Network overview**
...
![Alt Image Text](../images/az103_9_5.png "Body image")


### **1-2 Create a virtual network using the portal**
...
### **1-3 Create a virtual network using PowerShell**
...
### **1-4 Create a network interface**
...
### **1-5 Azure IP addressing overview**
...
### **1-6 Configure virtual machine IP addresses using the portal**
...
### **1-7 Create a private IP address using PowerShell**
...
### **1-8 Create a public IP address**
...
### **1-9 Azure route table overview**
...
### **2-2 Create and configure VNet peering in the portal**

**Add peering(A->B)**

![Alt Image Text](../images/az103_9_21.png "Body image")
...
### **2-3 Create and configure VNet peering using PowerShell**
...
![Alt Image Text](../images/az103_9_27.png "Body image")
...
### **3-2 Create and configure Azure DNS using PowerShell**
...
![Alt Image Text](../images/az103_9_39.png "Body image")
